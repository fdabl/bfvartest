...
namespace model_BayesLeveneMixed_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BayesLeveneMixed");
    reader.add_event(52, 50, "end", "model_BayesLeveneMixed");
    return reader;
}

#include <meta_header.hpp>
 class model_BayesLeveneMixed : public prob_grad {
private:
    int k;
    double alpha;
    int nr_equal;
    ...
    double nplus;
public:
    model_BayesLeveneMixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_BayesLeveneMixed_namespace::model_BayesLeveneMixed";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_BayesLeveneMixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_BayesLeveneMixed_namespace::model_BayesLeveneMixed stan_model;
