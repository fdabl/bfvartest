...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("lambda_unconstrained", "(k - nr_equal)", (k - nr_equal));
        context__.validate_dims("parameter initialization", "lambda_unconstrained", "double", context__.to_vec((k - nr_equal)));
        std::vector<double> lambda_unconstrained((k - nr_equal), double(0));
        size_t lambda_unconstrained_k_0_max__ = (k - nr_equal);
        for (size_t k_0__ = 0; k_0__ < lambda_unconstrained_k_0_max__; ++k_0__) {
            lambda_unconstrained[k_0__] = vals_r__[pos__++];
        }
        size_t lambda_unconstrained_i_0_max__ = (k - nr_equal);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            size_t lambda_unconstrained_d_0_max__ = (k - nr_equal);
