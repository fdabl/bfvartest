...
namespace model_BayesLeveneOrdered_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BayesLeveneOrdered");
    reader.add_event(52, 50, "end", "model_BayesLeveneOrdered");
    return reader;
}

#include <meta_header.hpp>
 class model_BayesLeveneOrdered : public prob_grad {
private:
    int k;
    double alpha;
    int nr_equal;
    ...
    double nplus;
public:
    model_BayesLeveneOrdered(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_BayesLeveneOrdered_namespace::model_BayesLeveneOrdered";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("lambda_unconstrained", "k", k);
        context__.validate_dims("initialization", "lambda_unconstrained", "vector_d", context__.to_vec(k));
        vector_d lambda_unconstrained(static_cast<Eigen::VectorXd::Index>(k));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_BayesLeveneOrdered_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double tau = in__.scalar_lb_constrain(0);
        vector_d lambda_unconstrained = in__.positive_ordered_constrain(k);
    ...
    static std::string model_name() {
        return "model_BayesLeveneOrdered";
    }
...
typedef model_BayesLeveneOrdered_namespace::model_BayesLeveneOrdered stan_model;
